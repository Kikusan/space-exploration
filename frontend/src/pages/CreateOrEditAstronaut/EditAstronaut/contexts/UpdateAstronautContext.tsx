...
export const UpdateAstronautProvider: React.FC<ApiProviderProps> = ({
  service,
  children,
}) => {
  ...
  const contextValue = useMemo(
    () => ({ updateAstronaut, getById }),
    [updateAstronaut, getById],
  );
  return (
    <UpdateAstronautContext.Provider value={contextValue}>
      {children}
    </UpdateAstronautContext.Provider>
  );
};
